...
import { LayoutDashboard, FileText, Send, Sparkles, LogOut, Hexagon, FolderOpen } from 'lucide-react';
import { motion } from 'framer-motion';

// Role-aware nav — marketing_head/admin see content-generation framing
    ...
    <aside className="fixed left-0 top-0 h-full w-56 z-40 flex flex-col"
      ...
      <div className="flex-shrink-0 p-3" style={{ borderTop: '1px solid #1f1f27' }}>
        ...
        <div className="flex items-center gap-2.5 px-2 py-2 mb-1">
          <div className="w-7 h-7 rounded-lg bg-[#0F62FE]/12 border border-[#0F62FE]/20 flex items-center justify-center flex-shrink-0">
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-2 py-2 rounded-lg text-[#52525b] hover:bg-red-500/8 hover:text-red-400 transition-colors duration-150 text-[12px]"
        >
          <LogOut size={14} />
          <span>Sign out</span>
        </button>
